...
class Cuentas_Usuario_Routes {
    ...
    function load_dependencies(){
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . '/controllers/class-cuentas-usuario-controllers.php';

    }

	public function add_endpoints() {
        $_auth = new Cuentas_Auth( $this->plugin_name, $this->version) ;
        $_usuario_controllers = new Cuentas_Usuario_Controllers( $this->plugin_name, $this->version) ;
		...
		$endpoints = array(
			...
			array(
				'endpoint' => 'usuario/addUser',
				'method' => 'POST',
				'callback' => 'add_user',
				'permission' => 'user_can_add_user'
			),
			array(
				'endpoint' => 'usuario/(?P<id>\d+)',
				'method' => 'DELETE',
		...
		foreach ($endpoints as $e) {
			register_rest_route( 'cuentas/v1', $e['endpoint'], array(
				'methods' => $e['method'],
				'callback' => array($_usuario_controllers, $e['callback']),
