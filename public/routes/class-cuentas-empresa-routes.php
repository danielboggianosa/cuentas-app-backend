...
class Cuentas_Empresa_Routes {
    ...
    function load_dependencies(){
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . '/controllers/class-cuentas-empresa-controllers.php';

    }

	public function add_endpoints() {
        $_auth = new Cuentas_Auth( $this->plugin_name, $this->version) ;
        $_empresa_controllers = new Cuentas_Empresa_Controllers( $this->plugin_name, $this->version) ;
